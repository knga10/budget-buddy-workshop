# 1. Map the document, before you extract anything

**This is about understanding one document's structure**, not about choosing
what to build. If you're still choosing, use
[`00-kickoff.md` Path B](00-kickoff.md#path-b-im-still-looking) first.
